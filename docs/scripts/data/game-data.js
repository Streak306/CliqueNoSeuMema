...
export const SHOP = [
  ...
  {id:'plantacao',   name:'Jardim',             base:12000,        r:1.15, p:47.0,      limit:12,  icon:'docs/assets/images/fundo/jardim.png'},
  {id:'alojamento',  name:'Criadouro',          base:130000,       r:1.15, p:260.0,     limit:8,   icon:'docs/assets/images/fundo/criadouro.png'},
  {id:'casa',        name:'Mineração',          base:1400000,      r:1.15, p:1400.0,    limit:5,   icon:'docs/assets/images/fundo/mineracao.png'},
  {id:'xbox',        name:'Vila',               base:20000000,     r:1.15, p:7800.0,    limit:3,   icon:'docs/assets/images/fundo/vila.png'},
  {id:'computador',  name:'Gerador de Energia', base:330000000,    r:1.15, p:44000.0,   limit:3,   icon:'docs/assets/images/fundo/energia.png'},
  {id:'microfone',   name:'Estúdio de musica',  base:5100000000,   r:1.15, p:260000.0,  limit:2,   icon:'docs/assets/images/fundo/musica.png'},
...
export const ACHIEVEMENT_DATA = [
  ...
  { id:'ach-stardew', name:'Stardew Valley', description:'Tenha 12 Jardins', requirement:{ type:'building', building:'plantacao', count:12 } },
  { id:'ach-estabulo', name:'Estábulo', description:'Tenha 8 Jardins', requirement:{ type:'building', building:'plantacao', count:8 } },
  { id:'ach-aluguel', name:'Aluguel', description:'Tenha 5 Minerações', requirement:{ type:'building', building:'casa', count:5 } },
  { id:'ach-xbox', name:'Xbox One', description:'Tenha 3 Vilas', requirement:{ type:'building', building:'xbox', count:3 } },
  { id:'ach-garoto-programas', name:'Garoto dos programas', description:'Tenha 3 Geradores de Energia', requirement:{ type:'building', building:'computador', count:3 } },
  { id:'ach-cantor', name:'Cantor', description:'Tenha 2 Estúdios de musica', requirement:{ type:'building', building:'microfone', count:2 } },
